...
<div class="container pt-3">
    ...
    <div class="row">
        ...
        <table style="width:100%">
                <tr>
                    <td style="text-align:center">capellan@um.edu.mx</td>
                </tr>
            </table>
        </div>
    </div>
...
<div class="container pt-3">
    ...
    <div class="row">
        ...
        <table style="width:100%">
                <tr>
                    <td style="text-align:left">Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                    Aperiam distinctio in ea. Optio ea laboriosam voluptatum facere, unde aperiam corrupti facilis. 
                    Quaerat reiciendis quis inventore eos eaque consequatur dolorem optio?</td>
                </tr>
            </table>
        </div>
        <div class="col col-md-6 align-self-center">
